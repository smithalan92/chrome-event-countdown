<template>
  <div
    class="m-add-sticky-note__overlay"
    ...
    <transition name="slideDown">
      <div
        ...
        <div class="m-add-sticky-note__header">
          <div class="m-add-sticky-note__header-title">
            Add Sticky Note
          </div>
          <div
            class="m-add-sticky-note__header-close"
            @click="close">
            <close-icon class="m-add-sticky-note__header-close-icon"/>
          </div>
        </div>
        <div class="m-add-sticky-note__body">
          <textarea class="m-add-sticky-note__textarea" v-model="text" ref="textarea" rows="10"></textarea>
        </div>
